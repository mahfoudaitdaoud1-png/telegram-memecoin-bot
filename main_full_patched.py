...
# --- PATCH: Followed-by runtime loader and admin commands ---
...
def _load_env_following() -> Set[str]:
    inline = os.getenv("MY_FOLLOWING_INLINE", "")
...
async def cmd_setfollowing(u: Update, c: ContextTypes.DEFAULT_TYPE):
    """Reply to a text list or pass handles inline: /setfollowing h1 h2 h3"""
    handles: Set[str] = set()
