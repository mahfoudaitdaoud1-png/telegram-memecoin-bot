...
class DexScreenerService:
    ...
    async def enrich_token_info(self, token_data: dict) -> TokenInfo:
        ...
        return TokenInfo(
            ...
            liquidity_usd=float((token_data.get("liquidity") or {}).get("usd", 0)),
            mcap_usd=float(token_data.get("fdv", 0)),
            vol24_usd=float((token_data.get("volume") or {}).get("h24", 0)),
...
async def startup_event():
    """Start the bot when FastAPI starts"""
    start_bot()
